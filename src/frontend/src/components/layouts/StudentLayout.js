      ...
      <div className="flex-grow-1 d-flex">
        ...
        <div className="bg-light d-none d-lg-flex flex-column border-end" style={{ width: '250px' }}>
          <Nav className="flex-column p-3">
            <Nav.Link
              ...
              className={`mb-2 ${isActive('/student/dashboard') ? 'active bg-primary text-white' : ''}`}
            >
            ...
            <Nav.Link
              ...
              className={`mb-2 ${isActive('/student/interests') ? 'active bg-primary text-white' : ''}`}
            >
        ...
        <Offcanvas show={showSidebar} onHide={() => setShowSidebar(false)} responsive="lg">
          <Offcanvas.Header closeButton>
            <Offcanvas.Title>Menu do Aluno</Offcanvas.Title>
          </Offcanvas.Header>
          <Offcanvas.Body>
